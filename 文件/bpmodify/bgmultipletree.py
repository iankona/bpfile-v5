...
from .btype import bbyte
from .btype import bchar
...
class 类(stacke_python.类):
    ...
    def bnodeuint8(self, num=1, name=""):
        ...
        bnode = bbyte(name=name, endian=self.endian).uint8_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeuint16(self, num=1, name=""):
        ...
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).uint16_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeuint32(self, num=1, name=""):
        ...
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).uint32_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeuint64(self, num=1, name=""):
        ...
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).uint64_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeint8(self, num=1, name=""):
        left, right = self.__calc__size__(num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).int8_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeint16(self, num=1, name=""):
        left, right = self.__calc__size__(2*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).int16_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeint32(self, num=1, name=""):
        left, right = self.__calc__size__(4*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).int32_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeint64(self, num=1, name=""):
        left, right = self.__calc__size__(8*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).int64_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodefloat16(self, num=1, name=""):
        left, right = self.__calc__size__(2*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).float16_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodefloat32(self, num=1, name=""):
        left, right = self.__calc__size__(4*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).float32_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodefloat64(self, num=1, name=""):
        left, right = self.__calc__size__(8*num)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).float64_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeascii(self, bytenum, name=""):
        ...
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).ascii_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def bnodeutf8(self, bytenum, name=""):
        left, right = self.__calc__size__(bytenum)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).utf8_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[self.__check__name__(name)] = bnode
        return bnode
    ...
    def bnodegbk(self, bytenum, name=""):
        left, right = self.__calc__size__(bytenum)
        name = self.__check__name__(name)
        bnode = bbyte(name=name, endian=self.endian).gbk_frombyte(self.mpbyte[left:right])
        bnode.parent = self
        self.name_object_dict[name] = bnode
        return bnode
    ...
    def addstring(self, char, name="", inttype="uint8", strtype="utf8"):
        bnode = bchar(inttype=inttype, strtype=strtype, endian=self.endian).fromstring(char)
        bnode.parent = self
        self.name_object_dict[self.__check__name__(name)] = bnode
        return bnode
